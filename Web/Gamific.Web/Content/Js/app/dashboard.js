            ...
            for (var i in cardResults) {
                ...
                if (cardResults[i].metricName == "Check-In") {
                    ...
                    card += "<div class='card-container col-lg-3 col-md-3 col-sm-6'>"
                            ...
                            + "<i class='fa " + cardResults[i].iconMetric + " media-object'></i>"
                            + "</span>"
                            + "<small style='padding-left: 5%; color: white; font-weight: bolder;'>" + cardResults[i].metricName + "</small>"
                            + "<h2 class='media-heading animate-number'>"
                            ...
                            + "<div class='details'>"
                            + "<div class='status pull-right bg-transparent-black-1'>"
                            + "<div style='color: white; font-weight: bolder;'>Meta: <span id='" + cardResults[i].metricId + "-goal'></span></div>"
                            + "</div>"
                            + "</div>"
                            + "<div class='status pull-right bg-transparent-black-1'>"
                            + "<div style='color: white; font-weight: bolder;'><span id='" + cardResults[i].metricId + "-percent' class='animate-number'>23</span>%</div>"
                            + "</div>"
                            + "<div class='clearfix'></div>"
                            + "<div id='a" + cardResults[i].metricId + "-bar' class='bar-prog'></div>"
                            + "</div>"

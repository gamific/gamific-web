...
{
    [RoutePrefix("public/dashboardHistorico")]
    [CustomAuthorize(Roles = "WORKER,LIDER,ADMINISTRADOR")]

    public class DashboardHistoricoController : BaseController
    {
        ...
        public ActionResult Index(int state = 1)
        {
            ...
            GetAllDTO all = EpisodeEngineService.Instance.GetByGameIdAndInactive(CurrentFirm.ExternalId, 0);
        ...
        */
        ...
        public ActionResult SearchTeams(string episodeId)
        {
            ...
            List<string> subTeamsNull = all.List.team.Select(x => x.Id).ToList();

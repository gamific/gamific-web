    ...
    public class UserRepository<TUser> where TUser : IdentityUser
    {
        ...
        public void Insert(TUser user)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                MySqlHelper.ExecuteNonQuery(conn, @"INSERT INTO Account_UserAccount VALUES(@Id,@Email,@EmailConfirmed,@PasswordHash,@SecurityStamp,@PhoneNumber,@PhoneNumberConfirmed,
        ...
        public void Delete(TUser user)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                MySqlHelper.ExecuteNonQuery(conn, @"DELETE FROM Account_UserAccount WHERE Id=@Id", parameters);
            }
        }
        ...
        public IQueryable<TUser> GetAll()
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName FROM Account_UserAccount", null);
        ...
        public long GetCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                var reader = MySqlHelper.ExecuteScalar(conn, CommandType.Text, @"SELECT  COUNT(*) FROM Account_UserAccount", null);
        ...
        public TUser GetById(string userId)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var reader = MySqlHelper.ExecuteReader(conn, CommandType.Text,
                    @"SELECT Id,Email,EmailConfirmed,
                PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,
                LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName FROM Account_UserAccount WHERE Id=@Id", parameters);
                while (reader.Read())
                {
                    user.Id = reader[0].ToString();
                    user.Email = reader[1].ToString();
        ...
        public TUser GetByName(string userName)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var reader = MySqlHelper.ExecuteReader(conn, CommandType.Text,
                    @"SELECT Id,Email,EmailConfirmed,
                PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,
                LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName FROM Account_UserAccount WHERE UserName=@UserName", parameters);
                while (reader.Read())
                {
                    user.Id = reader[0].ToString();
                    user.Email = reader[1].ToString();
        ...
        public TUser GetByEmail(string email)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var reader = MySqlHelper.ExecuteReader(conn, CommandType.Text,
                    @"SELECT Id,Email,EmailConfirmed,
                PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,
                LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName FROM Account_UserAccount WHERE Email=@Email", parameters);
                while (reader.Read())
                {
                    user.Id = reader[0].ToString();
                    user.Email = reader[1].ToString();
        ...
        public void Update(TUser user)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                MySqlHelper.ExecuteNonQuery(conn, @"UPDATE Account_UserAccount 
